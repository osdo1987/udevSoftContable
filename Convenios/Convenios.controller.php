...
function obtener_registros($conexion)
{
    ...
    try {
        ...
        foreach ($resultado as $fila) {
            ...
            $sub_array[] = '<button type="button" data-bs-toggle="modal" data-bs-target="#modalConvenio" name="editar" id="' . $fila["codigo_convenio"] . '" class="btn btn-warning bi bi-pencil-square editar"></button>';
