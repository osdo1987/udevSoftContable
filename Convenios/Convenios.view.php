          ...
          <div class="modal-content">
            ...
            <div class="modal-content">
              <div class="modal-body">
                ...
                <input type="number" name="codigo_movimiento" id="codigo_movimiento" class="form-control">
                <br>
                ...
                <input type="number" id="codigo_servicio" name="codigo_servicio" class="form-control">
                <br>
              </div>
            </div>
      ...
      <script>
        $(document).ready(function () {
          ...
          $("#btn-pagar").click(function () {
            $("#formularioPago")[0].reset(); // Resetear el formulario
          ...
          $(document).on('submit', '#formularioPago', function (event) {
            ...
            var codigo_movimiento = $("#codigo_movimiento").val();
            ...
            var codigo_fk_estudiante = $("#codigo_fk_estudiante").val();
            ...
            $.ajax({
              ...
              data: {
                ...
                codigo_fk_estudiante: codigo_fk_estudiante,
